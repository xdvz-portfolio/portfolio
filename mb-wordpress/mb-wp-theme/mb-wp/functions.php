 ...
 */
function mb_scripts() {
	wp_enqueue_style( 'mb-style', get_stylesheet_uri(), array(), _S_VERSION );
    wp_enqueue_style( 'enqueue-that-css', get_template_directory_uri() . '/public/css/app.css', array(), _S_VERSION, 'all');

//	wp_enqueue_script( 'mb-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
    wp_enqueue_script( 'enqueue-that-js', get_template_directory_uri() . '/public/js/app.js', array (), _S_VERSION, true);
