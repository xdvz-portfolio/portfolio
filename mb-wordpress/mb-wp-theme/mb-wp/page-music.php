...
get_header();
?>
<header class="section music__fs" id="up">
    <div class="container_center anim_cont">

        <div class="fscreen__title wow fadeInUp">Живые звуковые пейзажи </div>
        <div class="fscreen__subtitle wow fadeInUp">Сервис автоматически анализирует актуальные музыкальные предпочтения пользователей и их конечных потребителей. мб всегда на гребне волны изменчивых музыкальных вкусов аудитории.</div>
        <div class="fscreen__btn wow fadeInUp"><a href="/request" class="btn">Тест-плей на 3 дня</a></div>

    </div>
</header>

<script type="text/x-template" id="player-select-template">
    <div class="playerList wow fadeInUp anim_cont">
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Неделя</div>
            <player :tracks="top10WeekTracks" />
        </div>
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Месяц</div>
            <player :tracks="top10MonthTracks" />
        </div>
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Все время</div>
            <player :tracks="top10AllTracks" />
        </div>
    </div>
</script>

<script type="text/x-template" id="player-genres-template">
    <div class="playerList wow fadeInUp anim_cont">
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Deep House</div>
            <player :tracks="top10WeekTracks" />
        </div>
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Chillout</div>
            <player :tracks="top10MonthTracks" />
        </div>
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Pop</div>
            <player :tracks="top10AllTracks" />
        </div>
    </div>
</script>

<script type="text/x-template" id="player-business-template">
    <div class="playerList wow fadeInUp anim_cont">
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Питание</div>
            <player :tracks="top10WeekTracks" />
        </div>
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Ритейл</div>
            <player :tracks="top10MonthTracks" />
        </div>
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Спорт</div>
            <player :tracks="top10AllTracks" />
        </div>
    </div>
</script>

<script type="text/x-template" id="player-artists-template">
    <div class="playerList wow fadeInUp anim_cont">
        <div class="playerList__item wow fadeInUp">
            <div class="playerList__title">Топ 10 / Неделя</div>
            <player :tracks="top10WeekTracks" />
...
<script type="text/x-template" id="player-template">
    <div class="player" v-if="initialized">
        ...
        <div class="progress" ref="progress">
            <div class="progress__top">
                <div class="album-info" v-if="currentTrack !== null">
...
<div class="featuresMusic">
    <div class="container_center">

        <div class="parallax-window wow fadeInUp" data-image-src="<?php bloginfo('template_url'); ?>/img/music/2-layers.png">
        </div>

        <div class="featuresMusic__list anim_cont">
            <div class="featuresMusic__item wow fadeInUp">
                <div class="featuresMusic__itemcont">
                    <div class="featuresMusic__number">2k</div>
                    <div class="featuresMusic__text">часов музыки</div>
                </div>
            </div>
            <div class="featuresMusic__item wow fadeInUp">
                <div class="featuresMusic__itemcont">
                    <div class="featuresMusic__number">25</div>
                    <div class="featuresMusic__text">музыкальных жанров</div>
                </div>
            </div>
            <div class="featuresMusic__item wow fadeInUp">
                <div class="featuresMusic__itemcont">
                    <div class="featuresMusic__number">139</div>
                    <div class="featuresMusic__text">новых лент в день</div>
                </div>
            </div>
            <div class="featuresMusic__item wow fadeInUp">
                <div class="featuresMusic__itemcont">
                    <div class="featuresMusic__number">7k</div>
                    <div class="featuresMusic__text">поигрываний в день</div>
                </div>
            </div>
        </div>
    ...
    <div class="featuresMusicSlider">
        <div class="featuresMusic__slider horiz-scroll">
            <div class="featuresMusic__item wow fadeInUp">
                <div class="featuresMusic__itemcont">
                    <div class="featuresMusic__number">2k</div>
                    <div class="featuresMusic__text">часов музыки</div>
...
<div class="playerContainer">
    <div class="container_center anim_cont">
        ...
        <div class="sectionTitle playerContainer__title wow fadeInUp">
            Выбор пользователей
        </div>

        <div id="Playlist_select"></div>
    ...
    <div class="container_center">
        ...
        <div class="collectionList">
            <div class="collectionList__item" >
                <div class="collectionList__img">
                    <div class="collectionList__slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="<?php bloginfo('template_url'); ?>/img/music/collection1.png" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="<?php bloginfo('template_url'); ?>/img/music/collection2.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="collectionList__pagination"></div>
                </div>
            </div>
            <div class="collectionList__item wow fadeInUp">
                <div class="collectionList__title">Готовые подборки</div>
                <div class="collectionList__text">Пользуйтесь  рекомендуемыми готовыми музыкальными подборками для различных типов предприятий, создавайте  нужное настроение для аудитории в несколько кликов.</div>
                <div class="collectionList__btn"><a href="/request" class="btn">Тест-плей на 3 дня</a></div>
            </div>
        </div>
...
<div class="playerContainer">
    <div class="container_center anim_cont">
        ...
        <div id="Playlist_genres"></div>

        <div class="Playlist__slider">
            <div id="Playlist_genres"></div>
        </div>
...
<div class="editor">
    <div class="container_center">
        ...
        <div class="editor__container anim_cont">
            <div class="editor__bg scaleble-bg">
            </div>
            <div class="editor__title wow fadeInUp">Редактор спешит на помощь</div>
            <div class="editor__text wow fadeInUp">Специлисты компании настроят плейлисты и ленты вне зависимости  от выбранного тарифа.</div>
            <div class="editor__btn wow fadeInUp">
                <a href="/request" class="btn">Тест-плей на 3 дня</a>
            </div>
        </div>
...
<div class="playerContainer">
    <div class="container_center anim_cont">
        <div class="sectionTitle playerContainer__title wow fadeInUp">
            Популярные треки по нишам
        </div>

        <div id="Playlist_business"></div>
    </div>
</div>
...
<div class="owner">
    <div class="container_center">
        ...
        <div class="ownerList">
            <div class="ownerList__left">
                <div class="ownerList__list">
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner1.png" alt="">
                        </div>
                    </div>
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner2.png" alt="">
                        </div>
                    </div>
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner3.png" alt="">
                        </div>
                    </div>
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner4.png" alt="">
                        </div>
                    </div>
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner5.png" alt="">
                        </div>
                    </div>
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner6.png" alt="">
                        </div>
                    </div>
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner7.png" alt="">
                        </div>
                    </div>
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner8.png" alt="">
                        </div>
                    </div>
                    <div class="ownerList__item">
                        <div class="ownerList__img">
                            <img src="<?php bloginfo('template_url'); ?>/img/music/owner9.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="ownerList__right wow fadeInUp">
                <div class="ownerList__title">Владельцам прав на музыку.</div>
                <div class="ownerList__text">Присоединяйтесь к нашему сообществу правообладателей, продюсеров, авторов, музыкантов и диджеев. Зарабатывйте и продвигайте Ваш музыкальный контент с помощью мб</div>
                <div class="ownerList__btn">
...
<div class="playerContainer">
    <div class="container_center anim_cont">
        <div class="sectionTitle playerContainer__title wow fadeInUp">
            Популярные треки артистов
        </div>

        <div id="Playlist_artists"></div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document)['ready'](function () {
        ...
        new Vue({
            ...
            data: function() {
                return {
                    top10AllTracks: Top10AllTracks(),
                    top10MonthTracks: Top10MonthTracks(),
                    top10WeekTracks: Top10WeekTracks()
                };
            },
            template: '<player-app :top10AllTracks="top10AllTracks" :top10WeekTracks="top10WeekTracks" :top10MonthTracks="top10MonthTracks" />',
            components: {
                'player-app': PlayerAppComponent_select(PlayerComponent()),
            }
        });
        ...
        new Vue({
            ...
            template: '<player-app :top10AllTracks="top10AllTracks" :top10WeekTracks="top10WeekTracks" :top10MonthTracks="top10MonthTracks" />',
            components: {
                'player-app': PlayerAppComponent_genres(PlayerComponent()),
            }
        });

        new Vue({
            el: '#Playlist_business',
            data: function() {
                return {
                    top10AllTracks: Top10AllTracks(),
                    top10MonthTracks: Top10MonthTracks(),
            ...
            template: '<player-app :top10AllTracks="top10AllTracks" :top10WeekTracks="top10WeekTracks" :top10MonthTracks="top10MonthTracks" />',
            components: {
                'player-app': PlayerAppComponent_business(PlayerComponent()),
            }
        });
        ...
        new Vue({
            ...
            template: '<player-app :top10AllTracks="top10AllTracks" :top10WeekTracks="top10WeekTracks" :top10MonthTracks="top10MonthTracks" />',
            components: {
                'player-app': PlayerAppComponent_artists(PlayerComponent()),
            }
        });
    });
</script>
